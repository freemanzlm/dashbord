	...
	<c:when test="${hasListingsNominated eq true}">
		<div class="listings-upload">
			...
			<div class="body mt20" style="width: 490px;">
				<p class="mt10">
					您可以通过下载<a class="template" href="/promotion/listings/downloadTemplate?promoId=${promo.promoId}" target="_self">已提交的品牌</a>修改并重新上传。
				</p>
				<p class="mt10">请注意：您新上传的品牌将完全替换之前的列表，并需要重新进行预审且接受活动条款。</p>
	...
	<c:otherwise>
		<div class="listings-upload">
			...
			<div class="body mt20" style="width: 545px;">
				<p>您可以通过下载<a class="template" href="/promotion/listings/downloadTemplate?promoId=${promo.promoId}" target="_self">品牌认证提交模板</a>按格式填写并上传您的认证信息。</p>
				<p><strong>请注意：您新上传的信息将全量替换之前的版本，系统以您最后上传的版本为准。</strong></p>
