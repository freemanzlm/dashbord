...
<div id="header">
	<div class="main"> 
		...
		<div class="head-nav">
			欢迎您，<bdi>${unm}</bdi> &nbsp;&nbsp; <a href="http://cbtreport.ebay.com.hk/dashboard/logout" style="font-weight: 400;">退出</a>
...
<div style="text-align: center; border: 2px solid red; line-height: 40px">企业入驻通道将会于6月29日 18:00 – 19:00进行系统维护，该时间段内将不能提交申请。</div>
