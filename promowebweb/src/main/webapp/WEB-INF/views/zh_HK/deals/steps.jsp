	...
	<div class="signpost-posts">
		<c:choose>
			...
			<c:when test="${ state eq 'Submitted' }">
				...
				<div class="post current-post"><span class="label">已提交預審</span></div>
				<div class="post"><span class="label">預審進行中</span></div>
				<div class="post"><span class="label">正式報名</span></div>
				<div class="post ${rewarding ? '':'last'}"><span class="label">活動進行中</span></div>
			</c:when>
			<c:when test="${ state eq 'Verifying' }">
				...
				<div class="post current-post"><span class="label">預審進行中</span></div>
				<div class="post"><span class="label">正式報名</span></div>
				<div class="post ${rewarding ? '':'last'}"><span class="label">活動進行中</span></div>
			</c:when>
			<c:when test="${ state eq 'PromotionApproved' }">
				<div class="post done"><span class="label">報名</span></div>
				<div class="post done"><span class="label">已提交預審</span></div>
				<div class="post done"><span class="label">預審進行中</span></div>
				<div class="post current-post"><span class="label">正式報名</span></div>
				<div class="post ${rewarding ? '':'last'}"><span class="label">活動進行中</span></div>
			</c:when>
