	...
	<div class="dialog-pane">
		<div class="dialog-body">
			<div class="pretty-text">
				<ol>
					<li>除非另有規定，本活動的參加者不可同時參加eBay組織舉辦的其他活動</li>
					<li>參加者的參加活動eBay帳戶及其關聯eBay帳戶均必須保持良好運作，於活動期間必需維持eBay全球賣家的最低標準，避免被暫停使用或被凍結，或逾期繳費，否則eBay有權取消參加資格或作其他决定。</li>
					<li>參加者及其刊登貨品，均須遵守eBay相關網站的所有條款及政策，包括但不限於刊登規則、違禁品及管制物品政策、保護知識產權方案等。如有違反，即喪失參加活動資格，並不得獲得可能產生的活動獎勵（如有）。參加者於活動期間將受所有eBay相關網站的使用條款及細則監管，並根據eBay正常環境運作。eBay並不對參加者的交易額作出保證亦不對其刊登及交易作出任何特別處理。參加者必須理解網上交易的風險及自行承擔一切後果。</li>
