...
<div class="tabbable confirm-letter-steps">
	<div class="tab-list-container clr" v-cloak>
		<ul class="tab-list clr" role="tablist">
			...
			<li role="tab" aria-controls="pane2" v-if="hasSubmitFields" v-bind:class="{active: hasSubmitFields && !hasApproved && hasSubmitAttachments}" v-bind:disabled="hasApproved"><span class="label">
			...
			<c:when test="${ subsidyTerm.subsidyType eq 2 }">
				<div class="promo-state-message">
					<div class="message-content">
						<h3 class="color-green text-center">您已成功领取等值 ${reward} ${promo.currency}的ebay万里通积分！</h3>
					</div>
					<menu>
