			...
			<div class="pane">
				...
				<div class="steps-wrapper">
					<div class="steps clr">
						...
						<div class="step ${ state eq 'rewarding' ? 'current-step' : (state eq 'claimable' ? 'done' : '') }"><span>奖励确认中</span></div>
						<div class="step ${ state eq 'claimable' ? 'current-step' : '' }"><span>可申领奖励</span></div>
