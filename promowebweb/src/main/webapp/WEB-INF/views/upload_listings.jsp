...
<div class="listings-upload">
	...
	<div class="body mt20" style="width: 545px;">
		<p>您可以通过下载<a class="template" href="/promotion/deals/downloadSkuList?promoId=${promo.promoId}" target="_blank">批量提交模板</a>按格式填写并上传您的刊登参与本活动。</p>
		...
		<form id="upload-form" action="/promotion/deals/uploadDealsListings" class="mt20" method="post" enctype="multipart/form-data">
			选择上传您的刊登列表 
