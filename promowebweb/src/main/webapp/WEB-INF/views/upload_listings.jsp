	...
	<c:when test="${hasListingsNominated eq true}">
		<div class="listings-upload">
			...
			<div class="body mt20" style="width: 490px;">
				<p class="mt10">
					您可以通过下载<a class="template" href="/promotion/listings/downloadSkuList?promoId=${promo.promoId}" target="_self">已提交的刊登物品</a>修改并重新上传。
				</p>
				...
				<form id="upload-form" action="/promotion/listings/uploadDealsListings" class="mt30" method="post"
	...
	<c:otherwise>
		<div class="listings-upload">
			...
			<div class="body mt20" style="width: 545px;">
				<p>您可以通过下载<a class="template" href="/promotion/listings/downloadSkuList?promoId=${promo.promoId}" target="_self">批量提交模板</a>按格式填写并上传您的刊登参与本活动。</p>
				
				<p id="upload-error-msg" class="error-msg hide"><span class="icon error"></span><b ></b></p>
				
				<form id="upload-form" action="/promotion/listings/uploadDealsListings" class="mt20" method="post" target="uploadIframe" enctype="multipart/form-data">
					选择上传您的刊登列表 
