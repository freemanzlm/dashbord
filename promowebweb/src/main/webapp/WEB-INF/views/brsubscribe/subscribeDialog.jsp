...
<div id="subscribe-dialog" class="subscribe-notice">
	...
	<div class="subscribe-content">
		...
		<div class="actions">
			...
			<br /> 
			<a href="http://community.ebay.cn/portal.php?mod=view&aid=246/" target="_blank">相关帮助</a>
		</div>
	</div>
</div>
</div>
			...
			success : function(data) {
				if (data.status == true) {
					...
					if (whitelistType == 1 || whitelistType == 3){
						...
						window.location.href = "http://biz.ebay.com.hk/bizreportweb/index?type=skusad&lang=zh_CN";
					}
				} else {
