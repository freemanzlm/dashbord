...
public class AuthInterceptor extends HandlerInterceptorAdapter {
	...
	private boolean authenticate (HttpServletRequest request,
		...
		/**
		 * TODO, remove or comment this back compatibility when DashBoard security branch is online.
		 * 
		 ...
		 */
		String sessionId = cookieMap.get(AppCookies.EBAY_SESSION_ID_COOKIE_NAME);
