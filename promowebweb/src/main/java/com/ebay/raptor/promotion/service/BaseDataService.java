...
public class BaseDataService {
    ...
    // biz report service
    private static String qaBizServicePrefix = "http://sdbrws.stratus.qa.ebay.com/br/v1/";
    private static String isAbleToAccessBizUrl;
    private static String getBizSubscribeMsgUrl;
    private static String addInWhitelistUrl;
    private static String subscribeDialogClosedUrl;
    ...
    static {
        if (CommonUtil.isProduction()) {
        	...
        	getBizSubscribeMsgUrl = "http://www.bizser.stratus.ebay.com/br/v1/subscription/subscriptionMsg/user/";
        	addInWhitelistUrl = "http://www.bizser.stratus.ebay.com/br/v1/subscription/addInWhitelist/user/";
        	subscribeDialogClosedUrl = "http://www.bizser.stratus.ebay.com/br/v1/subscription/subscribeDialogClosed/user/";
        	bizAuthorization = "";
        	...
        	isAbleToAccessBizUrl = qaBizServicePrefix + "userValidation/user/";
        	getBizSubscribeMsgUrl = qaBizServicePrefix + "subscription/subscriptionMsg/user/";
        	addInWhitelistUrl = qaBizServicePrefix + "subscription/addInWhitelist/user/";
        	subscribeDialogClosedUrl = qaBizServicePrefix + "subscription/subscribeDialogClosed/user/";
        	bizAuthorization = "";
	...
	public Map<String, Boolean> getSubscriptionMsg(Long userId) throws HttpRequestException {
		String json = httpRequestService.doHttpRequest(getBizSubscribeMsgUrl + userId, GET_METHOD, null, prepareHeaders());
	...
	public boolean addWhitelist(long userId, int whitelistType) throws HttpRequestException {
		String json = httpRequestService.doHttpRequest(addInWhitelistUrl + userId +"/whitelistType/"+ whitelistType
	...
	public boolean subscribeDialogClosed(long userId) throws HttpRequestException {
		String json = httpRequestService.doHttpRequest(subscribeDialogClosedUrl + userId,
				GET_METHOD, null, prepareHeaders());
		TypeToken<HttpResponseData<Boolean>> type = new TypeToken<HttpResponseData<Boolean>>(){};
